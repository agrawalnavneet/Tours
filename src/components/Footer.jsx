...
import lens1 from "../assets/lens1.png";
import aboutImg from "../assets/lens1.png"; // you can replace this with a proper about image
import "./Footer.css";
...
const Footer = () => {
  return (
    <footer
      className="footer"
      style={{ backgroundImage: `url(${lens1})` }}
    >
      {/* About Us Section */}
      <div className="footer-section about-us" id="about-us">
        <h2>About Us</h2>
        <div className="about-content">
          <img src={aboutImg} alt="Aviatours Travel" className="about-img" />
          <p>
            Aviatours Australia is your trusted travel partner, offering tailored
            tour packages, hotel bookings, and adventure experiences across the
            country. From the Great Barrier Reef to Tasmania’s wilderness, we
            bring authentic and unforgettable journeys.  
      ...
      <div className="footer-section contact-us" id="contact-us">
        ...
        <div className="social-icons">
          ...
          <a href="https://wa.me/61439551994" target="_blank" rel="noreferrer">
            <FaWhatsapp />
          </a>
        </div>
      </div>
